...
const WorkOrder = () => {
	...
	return (
		<div>
			<div className="text-xl">List Work Orders</div>
			<button className='my-4 bg-primary text-white py-2 px-3 rounded-lg hover:bg-slate-800'>Create A New Work Order</button>
			<table className="table-auto border-collapse border border-slate-400 w-full">
				...
				<tbody>
					<tr className='text-center'>
						...
						<td className='border border-slate-300'>Joko Kasmono</td>
