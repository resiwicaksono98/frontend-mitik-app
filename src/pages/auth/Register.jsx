			...
			<div className='flex  justify-center items-center'>
				<div className=' m-4 xl:mx-96 bg-white w-full rounded-xl  '>
					<div className="p-5 flex flex-col w-full items-center gap-3 text-primary tracking-wider">
						...
						<div className='text-sm '>Hey, Enter your details to get sign up your account</div>
						<form className='py-4'>
							...
							<div>Already have a acoount? <Link to={'/login'} className="underline hover:text-gray-500">Login Now</Link></div>
						</form>
					</div>
				</div>
			</div>
